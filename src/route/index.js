...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      ...
      certificates: [
        {
          name: 'Sertificate Secondary school',
          id: 101,
        },
        {
          name: 'Sertificate College',
          id: 102,
        },
        {
          name: 'Sertificate University',
          id: 103,
        },
      ],
    },
          ...
          projects: [
            {
              ...
              about: 'High-load application for resume',
              stackAmount: 3,
              stacks: [
                {
                  name: 'React.js',
              ...
              awards: [
                {
                  name: 'Dackground verification - is a future that provides users to prove that they arer real person',
                },
                {
